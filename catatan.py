...
#
# 🎛️ PANDUAN KONTROL TOMBOL KEYBOARD (MAPPED GESTURES):
# ------------------------------------------------------------------------------
# | TOMBOL KEYBOARD          | MODE | NAMA MODE             | EFEK VISUAL PARTIKEL |
# ------------------------------------------------------------------------------
# | TOMBOL F3       |  1   | ROTASI ANGCOSMOS      | Partikel biru acak   |
# |                      |      |                       | berputar lambat.     |
# |                      |      |                       |                      |
# | TOMBOL F6       |  2   | SATURNUS 3D           | Mengumpul jadi bola  |
# |          |      |                       | oranye & cincin emas.|
# |                      |      |                       |                      |
# | TOMBOL F7       |  3   | TEKS I LOVE YOU       | Berbaris membentuk   |
# |                      |      |                       | tulisan biru neon.   |
# |                      |      |                       |                      |
# | TOMBOL F11      |  4   | BENTUK HATI (LOVE)    | Mengalir membentuk   |
